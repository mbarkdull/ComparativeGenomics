...
def goatools_termfinder(forelist, backlist, database_file, go_dir):
    ...
    cmd = ["/workdir/mb2337/RubinGOEnrichment/goatools/scripts/find_enrichment.py", "%s/forelist.txt" % go_dir, "%s/backlist.txt" % go_dir, database_file, "--obo", "./goatools/goatools/scripts/go-basic.obo", "--pval", "10", "--outfile", "%s_ps.txt" % (go_dir)]
    subprocess.call(cmd)
